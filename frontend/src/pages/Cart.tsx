...
const Cart = () => {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-6 sapce-y-6">
      ...
      <div className="space-y-4">
        {cart.map((cartItem: ICart) => {
          ...
          return (
            <div
              key={item._id}
              className="flex items-center ga-4 rounded-xl bg-white p-4 shadow-sm"
            >
              <img
                src={item.image}
                alt=""
      ...
      <div className="rounded-xl bg-white p-4. shadow-sm space-y-3  ">
        ...
        <button
          onClick={clearCart}
          className="mt-3 w-full rounded-lg bg-[#231f20] py-3 text-sm font-semibold text-white hover:bg-gray-900 flex justify-center items-center gap-3 "
