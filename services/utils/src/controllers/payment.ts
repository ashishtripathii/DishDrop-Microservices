...
import { publishPaymentSuccess } from "../config/payment_producer.js";
...
export const verifyRazorpayPayment = async (req: Request, res: Response) => {
  ...
  return res.status(200).json({
    message: "Payment verifired successfully",
  });
};
